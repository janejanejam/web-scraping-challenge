# Project: Mission to Mars Web Application
...
* Create a route called `/scrape` that will import `scrape_mars.py` script and call functions.
...
![1](Mission_to_Mars/screenshots/screenshot1.png)
![2](Mission_to_Mars/screenshots/screenshot2.png)
